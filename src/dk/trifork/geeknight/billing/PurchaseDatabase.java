...
public class PurchaseDatabase {
    ...
    public Cursor queryTransactions(String productId) {
        return mDb.query(PURCHASED_ITEMS_TABLE_NAME, PURCHASED_COLUMNS, PURCHASED_PRODUCT_ID_COL + " = ?", 
                new String[] {productId}, null, null, null);
    }
    
    public Cursor queryTransactions(String productId, PurchaseState state) {
        return mDb.query(PURCHASE_HISTORY_TABLE_NAME, HISTORY_COLUMNS, HISTORY_PRODUCT_ID_COL + " = ? AND " + HISTORY_STATE_COL + " = ?", 
