...
public class AdWhirlManager {
  ...
  public AdWhirlManager(WeakReference<Context> contextReference,
      String keyAdWhirl) {
    Logger.i(AdWhirlUtil.ADWHIRL, "Creating adWhirlManager...");
    this.contextReference = contextReference;
    this.keyAdWhirl = keyAdWhirl;

    localeString = Locale.getDefault().toString();
    Logger.d(AdWhirlUtil.ADWHIRL, "Locale is: " + localeString);
    ...
    Logger.d(AdWhirlUtil.ADWHIRL, "Hashed device ID is: " + deviceIDHash);

    Logger.i(AdWhirlUtil.ADWHIRL, "Finished creating adWhirlManager");
  }
  ...
  public Ration getRation() {
    ...
    Logger.d(AdWhirlUtil.ADWHIRL, "Dart is <" + r + "> of <" + totalWeight + ">");
  ...
  public Custom getCustom(String nid) {
    ...
    try {
      ...
      Logger.d(AdWhirlUtil.ADWHIRL, httpResponse.getStatusLine().toString());
      ...
      Logger.e(AdWhirlUtil.ADWHIRL, "Caught ClientProtocolException in getCustom()", e);
    } catch (IOException e) {
      Logger.e(AdWhirlUtil.ADWHIRL, "Caught IOException in getCustom()", e);
    }
  ...
  public void fetchConfig() {
    ...
    Logger.d(AdWhirlUtil.ADWHIRL, "Prefs{" + keyAdWhirl + "}: {\""
    ...
    if (jsonString == null || configExpireTimeout == -1
      ...
      try {
        ...
        Logger.e(AdWhirlUtil.ADWHIRL,
            "Caught ClientProtocolException in fetchConfig()", e);
      } catch (IOException e) {
        Logger.e(AdWhirlUtil.ADWHIRL, "Caught IOException in fetchConfig()", e);
      }
    } else {
      Logger.i(AdWhirlUtil.ADWHIRL, "Using stored config data");
    }
  ...
  private void parseConfigurationString(String jsonString) {
    Logger.d(AdWhirlUtil.ADWHIRL, "Received jsonString: " + jsonString);
  ...
  private Custom parseCustomJsonString(String jsonString) {
    Logger.d(AdWhirlUtil.ADWHIRL, "Received custom jsonString: " + jsonString);
  ...
  private Drawable fetchImage(String urlString) {
    try {
      ...
      Logger.e(AdWhirlUtil.ADWHIRL, "Unable to fetchImage(): ", e);
      return null;
    }
  }
