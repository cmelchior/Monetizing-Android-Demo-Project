...
public class EventAdapter extends AdWhirlAdapter {
  ...
  @Override
  public void handle() {
    Logger.d(AdWhirlUtil.ADWHIRL, "Event notification request initiated");
    ...
    if (adWhirlLayout.adWhirlInterface != null) {
      ...
      String method = null;
      if (key == null) {
        Logger.w(AdWhirlUtil.ADWHIRL, "Event key is null");
      ...
      if (methodIndex < 0) {
        Logger.w(AdWhirlUtil.ADWHIRL, "Event key separator not found");
        adWhirlLayout.rollover();
        return;
      }
      ...
      try {
        ...
        Logger.e(AdWhirlUtil.ADWHIRL, "Caught exception in handle()", e);
        adWhirlLayout.rollover();
        return;
      }
    } else {
      Logger.w(AdWhirlUtil.ADWHIRL,
