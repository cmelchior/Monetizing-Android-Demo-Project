 ...
 */
/**
 * This file is not the original, but a version containing a fix for 
 * resizing images in house ads.
 * 
 * @see http://code.google.com/p/adwhirl/issues/detail?id=137
 * @see https://code.google.com/r/pilota51-adwhirl/source/browse/src/com/adwhirl/adapters/CustomAdapter.java?spec=svn031945e6eb9f5140dafbcf151ebd73e19eced16e&r=031945e6eb9f5140dafbcf151ebd73e19eced16e
 */
  ...
  public void displayCustom() {
    ...
    switch (adWhirlLayout.custom.type) {
      ...
      case AdWhirlUtil.CUSTOM_TYPE_ICON:
        ...
        int iconScale = LayoutParams.WRAP_CONTENT;
        ...
        frameImageView.setScaleType(ScaleType.FIT_CENTER);
